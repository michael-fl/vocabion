-- Widen the CHECK constraint on sessions.type to include 'starred'.
...
CREATE TABLE sessions_new (
  ...
  type       TEXT NOT NULL DEFAULT 'normal' CHECK(type IN ('normal', 'repetition', 'focus', 'discovery', 'starred'))
);
