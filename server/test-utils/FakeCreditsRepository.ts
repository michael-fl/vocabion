...
export class FakeCreditsRepository implements CreditsRepository {
  ...
  addStars(count: number): void {
    this.earnedStars += count
  }

  getStarsOfferSnoozedUntil(): string | null {
    return this.starsOfferSnoozedUntil
  }

  setStarsOfferSnoozedUntil(date: string | null): void {
    this.starsOfferSnoozedUntil = date
  }

  getStressSessionDueAt(): string | null {
    return this.stressSessionDueAt
  }
  ...
  getBreakthroughSessionDueAt(): string | null {
    return this.breakthroughSessionDueAt
  }
  ...
  getLastSecondChanceSessionDate(): string | null {
    return this.lastSecondChanceSessionDate
  }

  setLastSecondChanceSessionDate(date: string): void {
    this.lastSecondChanceSessionDate = date
  }
